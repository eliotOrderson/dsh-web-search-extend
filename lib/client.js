// Client half for dsh-web-search-extend.
  ...
  factory: () => {
    ...
    module.exports.apply = (ctx) => {
      ...
      try {
        ...
        console.warn("[dsh-web-search-extend] settings scope unavailable", error);
        return;
      }
      ...
      const currentProvider = () => {
        try {
          ...
          return snap?.value?.provider ?? snap?.base?.provider ?? "tavily";
        } catch { return "tavily"; }
      };
      ...
      const buildProviderSelect = () => {
        ...
        select.addEventListener("change", () => {
          try {
            ...
            console.warn("[dsh-web-search-extend] failed to persist provider", e);
          }
        });
      ...
      const buildMaxUsesField = () => {
        ...
        input.addEventListener("change", () => {
          ...
          try {
            ...
            console.warn("[dsh-web-search-extend] failed to persist maxUses", e);
          }
        });
