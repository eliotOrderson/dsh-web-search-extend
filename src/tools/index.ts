...
/** Registration gates; `config.tools.*` maps straight onto this (task t6). */
...
export function applyWebTools(ctx: Context, resolveOptions: () => ResolvedOptions, gates: WebToolsGates): void {
